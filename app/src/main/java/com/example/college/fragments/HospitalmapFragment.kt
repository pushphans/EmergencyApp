...
import com.example.college.databinding.FragmentHospitalmapBinding


class HospitalmapFragment : Fragment(R.layout.fragment_hospitalmap) {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHospitalmapBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    private fun setUpWebView() {
        binding.hospitalWebView.settings.setGeolocationEnabled(true)
        binding.hospitalWebView.settings.javaScriptEnabled = true
        binding.hospitalWebView.webChromeClient = object : WebChromeClient() {
        ...
        binding.hospitalWebView.webViewClient = WebViewClient()
    }

    private fun initializeWebview() {
        binding.hospitalWebView.loadUrl("https://www.google.com/search?q=hospitals+near+me")
    }
    ...
    override fun onResume() {
        ...
        (activity as AppCompatActivity).supportActionBar?.title = "Hospitals Near Me"
    }
