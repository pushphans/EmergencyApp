...
import com.example.college.databinding.FragmentFuelBinding
...
class FuelFragment : Fragment(R.layout.fragment_fuel) {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFuelBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    private fun setUpWebView() {
        binding.fuelWebView.settings.setGeolocationEnabled(true)
        binding.fuelWebView.settings.javaScriptEnabled = true
        binding.fuelWebView.webChromeClient = object : WebChromeClient() {
        ...
        binding.fuelWebView.webViewClient = WebViewClient()
    }

    private fun initializeWebview() {
        binding.fuelWebView.loadUrl("https://www.google.com/search?q=fuel+pumps+near+me")
    }
    ...
    override fun onResume() {
        ...
        (activity as AppCompatActivity).supportActionBar?.title = "Fuel Pumps Near Me"
    }
